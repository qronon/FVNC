...
public class RFBEncodingCopyRect extends RFBEncodingData
{
	...
	private static var screenImageDataCache:BitmapData;
	/**
	 * 
	 */
	override public function execute( screenImageData:BitmapData ):void
	{
		...
		if(!screenImageDataCache){
			screenImageDataCache = screenImageData.clone();
		}
		screenImageDataCache.copyPixels( screenImageData, 
		...
		screenImageData.copyPixels( screenImageDataCache, 
